<template class="mytemp">
  <q-card class="mydialog">
    ...
    >
      ...
      <div v-if="!this.user">
        <label class="title">
          Veuillez remplir le formulaire avec vos coordonnées.
        </label>
      </div>
      <br />
      <br />
        ...
        <q-item-section>
          ...
          <template>
            <div class="q-pa-md" style="max-width: 360px;margin-left:-120px">
              ...
              >
                <template v-slot:prepend>
                  <q-icon color="blue-10" name="event" class="cursor-pointer">
                    <q-popup-proxy
      ...
      <q-input
        outlined
        dense
        style="margin-left:245px;width:330px"
        color="blue-10"
      ...
      >
        <template v-slot:prepend>
          <div class="row items-center all-pointer-events">
            <q-icon class="q-mr-xs" color="blue-10" size="20px" name="home" />
          </div>
        </template>
      </q-input>
      <q-item>
...
<style scoped>
.mydialog {
  background: linear-gradient(90deg, rgba(5, 3, 99, 1), rgb(134, 146, 194));
  min-width: 740px;
  padding: 8px;
  height: 880px;
}
